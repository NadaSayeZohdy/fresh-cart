          ...
          >
            ...
            <ul className="flex flex-col md:flex-row justify-center items-center md:space-x-2">
              ...
              <li className="space-x-2 text-black">
                <a target="blank" href="https://www.facebook.com/profile.php?id=100094307020311&mibextid=ZbWKwL">
                  <i className="fab fa-facebook-f cursor-pointer"></i>
                </a>
                <a
                  target="blank"
                  href="http://www.linkedin.com/in/nada-zohdy-b62608289"
                >
                  <i className="fab fa-linkedin-in cursor-pointer"></i>
                </a>
                <a
                  target="blank"
                  href="https://twitter.com/NadaSayed279981"
                >
                  <i className="fab fa-twitter cursor-pointer"></i>
                </a>
                <a target="blank" href="https://github.com/NadaSayeZohdy">
                  <i className="fab fa-github cursor-pointer"></i>
                </a>
                <a
                  target="blank"
                  href="https://www.instagram.com/zohdy_nada/"
                >
